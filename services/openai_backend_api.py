...
class OpenAIBackendAPI:
    ...
    def _image_model_settings(self, model: str) -> tuple[str, str]:
        ...
        backend_model, effort = resolve_image_backend_route(model)
        return backend_model, effort
    ...
    def _prepare_image_conversation(
        ...
        *,
        ...
        default_backend_model, default_effort = self._image_model_settings(model)
        resolved_backend_model = backend_model or default_backend_model
        resolved_effort = default_effort if thinking_effort is None else thinking_effort
        payload = {
            "action": "next",
            "fork_from_shared_post": False,
            "parent_message_id": new_uuid(),
            "model": resolved_backend_model or self._image_model_slug(model),
